...
[awesome_LLMs_interview_notes](https://portrait.gitee.com/RapidAI/awesome_LLMs_interview_notes)
...
-  [ ] **[大模型（LLMs）langchain面]()**
  ...
  -  [ ] **[LLM文档对话 —— pdf解析关键问题](./大模型（LLMs）langchain面/LLM文档对话%20——%20pdf解析关键问题.md)**
    -  [ ] 一、为什么需要进行pdf解析？
    -  [ ] 二、为什么需要 对 pdf 进行解析？
